...
public:
  NsaReader(unsigned int nsa_offset = 0, char *path = NULL, int archive_type = ARCHIVE_TYPE_NSA,
  ...
  size_t putFile(FILE *fp, int no, size_t offset, size_t length, size_t original_length, int compression_type,
